...
const imgUrl =  window.location.href.includes('172.18.110.90') ? `http://172.18.110.25/planeacion-recuperadas/Historicos/${data[0].Folio}/${data[0].Folio}.jpg` : `http://187.216.250.245/planeacion-recuperadas/Historicos/${data[0].Folio}/${data[0].Folio}.jpg`;
